...
/*
 * $Id: privmanager.php,v 1.1 2003/10/26 08:28:42 wellwine Exp $
...
function privManagerLink()
{
    ...
    return sprintf(
        '<a href=\'%s/modules/%s/admin/privmanager.php\'>%s</a>',
        XOOPS_URL,
        $xoopsModule->dirname(),
        _AM_WEBLOG_PRIVMANAGER
    );
}
...
function privmanager()
{
    ...
    echo sprintf("<tr><th colspan='3'>%s</th></tr>", _AM_WEBLOG_PRIVMANAGER);
