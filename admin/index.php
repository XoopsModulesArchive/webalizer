...
/*
 * $Id: index.php,v 1.2 2003/10/26 08:28:42 wellwine Exp $
...
switch ($op) {
    default:
        xoops_cp_header();
        echo sprintf('<h4>%s</h4>', _AM_WEBALIZER_CONFIG);
        ...
        echo adminItem(
            sprintf(
                '%s/modules/system/admin.php?fct=preferences&amp;op=showmod&amp;mod=%d',
                XOOPS_URL,
                $xoopsModule->getVar('mid')
            ),
            _AM_WEBALIZER_PREFERENCES,
            _AM_WEBALIZER_PREFERENCESDSC
        );
